...
parser.add_argument('--save_path', type=str,  default='../LeCaRD-main/data/prediction/bert_L_res.json', help='save path')
parser.add_argument('--best_model_path', type=str,  default='Lecard_bert_best_model', help='best_model_path')
...
if args.data_type == 'elam':
    ...
    args.save_path = '../LeCaRD-main/data/prediction/bert_E_res.json'
    args.best_model_path = 'elam_bert_best_model'
    print('test elam')
